...
var _cloneDep = require('clone-dep');

var _cloneDep2 = _interopRequireDefault(_cloneDep);
...
async function buildQueryBodyFromSearchQuery(config, bodybuilder, searchQuery) {
  ...
  var appliedFilters = (0, _cloneDep2.default)(searchQuery.getAppliedFilters()); // copy as function below modifies the object
