...
export function buildQueryBodyFromSearchQuery(config, bodybuilder, searchQuery) {
 ...
 * }
 */
export function buildQueryBodyFromFilterObject(type, config, bodybuilder, filter, search = '') {
    return __awaiter(this, void 0, void 0, function* () {
