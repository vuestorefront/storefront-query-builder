    ...
    RequestBody.prototype.applyCatalogFilters = function () {
        ...
        if (this.hasCatalogFilters()) {
            ...
            catalogFilters.forEach(function (filter) {
                _this.queryChain
                    .orFilter('bool', function (b) { return _this.catalogFilterBuilder(b, filter); })
        ...
        if (filters.length > 0) {
            for (var _i = 0, filters_1 = filters; _i < filters_1.length; _i++) {
                ...
                if (this.checkIfObjectHasScope({ object: attribute, scope: 'catalog' })) {
                    ...
                    if (field !== 'price') {
                        var aggregationSize = { size: config.filterAggregationSize[field] || config.filterAggregationSize.default };
                        this.queryChain
